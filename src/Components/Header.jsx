      ...
      <div className="bg-green-400 m-2 rounded-lg justify-evenly grid-cols-3 grid items-center ">
        <div className="flex flex-col gap-5 ">
          <div className=" text-center ">
            <h2 className="text-yellow-300 text-5xl font-semibold">
              {" "}
              Savour{" "}
            ...
            <h2 className="text-5xl font-semibold text-yellow-300">
              {" "}
              of fruit in every sip.
            </h2>
          </div>

          <div>
            {" "}
            {/** the second header div by the left */}
            <h4 className="text-center ">
              Taste nature's best in every <strong> drop</strong> with real{" "}
              <strong>fruit </strong> and vibrant <strong> flavour</strong>
            </h4>
          </div>
        ...
        >
          ...
          <div>
            <p className="text-center text-amber-300 font-medium">
              Natural ingredients used in flavours
            </p>
          </div>
        </div>
      </div>
